        ...
        <AdminLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <h3 className="text-3xl font-bold text-slate-900 mb-1">{stats.pendingListings}</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <h3 className="text-3xl font-bold text-slate-900 mb-1">{stats.approvedListings}</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <h3 className="text-3xl font-bold text-slate-900 mb-1">{stats.todayViews}</h3>
